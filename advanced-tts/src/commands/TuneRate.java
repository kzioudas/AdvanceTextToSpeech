...
public class TuneRate implements ActionListener {
	Document document;
	ReplayManager replayManager;
	TextToSpeechUserView ttsuview;
	public TuneRate(TextToSpeechUserView ttsuview)
	{
	...
	public void actionPerformed(ActionEvent ae) {
		...
		JDialog dialog = optionPane.createDialog(ttsuview.getFrame(), "TuneRate");
